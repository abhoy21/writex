    ...
    >
      ...
      <div
        ...
        style={{
          ...
          maskImage:
            "radial-gradient(100% 70% at 50% 30%, rgba(0,0,0,1), rgba(0,0,0,0.05))",
        }}
      />

      <div className="relative z-10 mx-auto max-w-3xl text-center">
        <div className="mb-5 flex items-center justify-center gap-2">
          <span className="rounded-full border bg-white/70 px-2.5 py-1 text-xs font-medium shadow-sm">
            New
          </span>
        ...
        <h1 className="text-balance text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
          Turn your visions into convertible SEO-friendly content with WriteX-AI
        </h1>

        <p className="mt-4 text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
          Transform ideas into high-converting, search-optimized copy —
          instantly tailored for intent, keywords, and conversion paths.
        </p>
        ...
        <div className="mt-7 flex items-center justify-center gap-3">
          ...
          >
            <Link href="/signup">Try WriteX-AI for Free</Link>
          </Button> */}
          {/* <Button
            asChild
            variant="outline"
            className="rounded-full border-foreground/10 bg-white/80 backdrop-blur"
          >
            <Link href="#how-it-works" aria-label="See how WriteX-AI works">
              See How It Works
            </Link>
          </Button> */}
