...
export default function DashboardSearchSection({
  ...
  return (
    <div className='p-10 bg-gradient-to-br from-[#181818] via-neutral-950 to-[#181818] flex flex-col items-center justify-center text-supernova-200 rounded-xl shadow-supernova-700/45 shadow-sm'>
      ...
      <div className='w-full flex items-center justify-center'>
        <div className='flex items-center gap-2 p-2 rounded-lg bg-gradient-to-br from-neutral-900 via-neutral-950 to-neutral-900 my-4 w-[45%] border border-supernova-500/45'>
